defmodule ChannelDemoWeb.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule ChannelDemo.MyChannel do
        use ChannelDemoWeb, :channel
  ...
  """
  use Phoenix.Presence, otp_app: :channel_demo,
                        pubsub_server: ChannelDemo.PubSub
end
